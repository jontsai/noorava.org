  ...
  return (
    <>
      <main className="site-shell landing-page">
        ...
        >
          <div className="background-word join" aria-hidden="true">
            Join us
          </div>
          <div className="event-copy">
            ...
            <div className="event-body">
              <p>
                The Boundless Concert takes its name from the boundless nature
                of the human spirit – the limitless depth of music, poetry, and
                wisdom to awaken, inspire, and connect us beyond language,
                culture, and time.
              </p>
              <p>
                The evening is an immersive journey through the rich musical and
                spiritual heritage of Persia, featuring Alireza Shahmohammadi
                and his ensemble performing two distinct sets of Persian
                Classical music. The first set explores the ancient modal
                traditions of Persia, drawing from a musical lineage cultivated
                and preserved for thousands of years. These timeless melodies
                offer a rare glimpse into one of the world’s oldest continuous
                musical traditions.
              </p>
              <p>
                The second set presents contemporary Persian classical
                compositions alongside timeless songs of love, longing, and
                devotion. Rooted in the poetry of the great Persian mystics,
                these works express the universal human longing for truth,
              ...
              <p>
                ...
                dedicated to preserving and sharing the timeless wisdom of Rumi
                and the Philosophy of Light (Hekmat-e Khosravani). Through
                music, poetry, education, and the arts, NoorAva seeks to make
                this profound tradition accessible to contemporary audiences
                while supporting the preservation and continued evolution of
                authentic Persian classical music.
              </p>
              <p>
                The evening is designed not simply to entertain, but to inspire
                reflection, awaken a deeper appreciation for Persian culture,
                and create an experience where music, poetry, and wisdom become
                a single expression of the human spirit.
              </p>
